...
public class Kuv100 extends Mahindra {
	String varient;
	String engine;
	String transmission;
	int capacity;
	...
	Kuv100(String varient,String engine,String transmission,int capacity,double mileage){
	...
	public void pay() {
		   ...
		   int a=sc.nextInt();
		  		   switch(a)
		   {
		   case 1: System.out.println("your amount is 6.08L for payment press 1 |To exit press 2");
		        int b=sc.nextInt();
		  ...
		  break;
		   case 2:System.out.println("your amount is 6.63L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 6.57L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 7.10L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		  	...
		  	// payment method for variant 4
		  		  	public void pay3() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 7.74L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 8.05L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
	...
	public void vari() {
		...
		System.out.println("1:G80 K2|2:G80 K4|3:G80 K6 |4:G80 K8");
		Kuv100 s=new Kuv100("G80 K2","1198cc","Manual",6,18.16);
		Kuv100 s1=new Kuv100("G80 K4","1198cc","Manual",6,18.16);
		Kuv100 s2=new Kuv100("G80 K6","1198cc","Automatic",6,18.16);
		Kuv100 s3=new Kuv100("G80 K8 ","1198cc","Manual",6,18.16);
		...
		switch(i) {
		case 1:
			System.out.println("Specifications:"  + "Varient:"+ s.varient + "\n"  + "Engine:" + s.engine + "\n"  + "Transmission:" + s.transmission + "\n"  + "Seating Capacity:" + s.capacity + "\n"  + "Added features:"+"Power windows"+"Power Steering"+"Air conditioner");
