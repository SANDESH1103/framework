...
public class Wagon extends Suzuki {
	String varient;
	String engine;
	String transmission;
	int capacity;
	...
	Wagon(String varient,String engine,String transmission,int capacity,double mileage){
	...
	public void pay() {
		   ...
		   int a=sc.nextInt();
		  		   switch(a)
		   {
		   case 1: System.out.println("your amount is 4.93L for payment press 1 |To exit press 2");
		        int b=sc.nextInt();
		  ...
		  break;
		   case 2:System.out.println("your amount is 5.04L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 5.25L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  		  ...
		  		  break;
		  		   case 2:System.out.println("your amount is 5.36L for payment press 1 |To exit press 2");
		  		   int c=sc.nextInt();
		  	       switch(c) {
		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		  		   break;
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2() {
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 5.84L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
		  	...
		  	// payment method for variant 4
		  		  	public void pay3() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 5.95L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 6.04L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
		  		...
		  		// payment method for variant 5  	
		  		  ...
		  		  public void pay4() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 6.45L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
	 		  		  ...
	 		  		  break;
	 		  		   case 2:System.out.println("your amount is 6.54L for payment press 1 |To exit press 2");
	 		  		   int c=sc.nextInt();
	 		  	       switch(c) {
	 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
	 		  		   break;
	...
	public void vari() {
		...
		Wagon s=new Wagon("LXI","998cc","Manual",5,21.79);
		Wagon s1=new Wagon("VXI","998cc","Manual",5,21.79);
		Wagon s2=new Wagon("VXI AMT","998cc","Automatic",5,21.79);
		Wagon s3=new Wagon("ZXI ","1197cc","Manual",5,21.79);
		Wagon s4=new Wagon("ZXI AMT","1197cc","Automatic",5,21.79);
