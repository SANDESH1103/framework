...
public class Punch extends Tata{
   ...
   Punch(){
	...
	Punch(String varient,String engine,String transmission,int capacity,double mileage){
	...
	public void pay() {
		   ...
		   int a=sc.nextInt();
		  		   switch(a)
		   {
		   case 1: System.out.println("your amount is 5.49L for payment press 1 |To exit press 2");
		        int b=sc.nextInt();
		  ...
		  break;
		   case 2:System.out.println("your amount is 5.68L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 6.39L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  		  ...
		  		  break;
		  		   case 2:System.out.println("your amount is 6.58L for payment press 1 |To exit press 2");
		  		   int c=sc.nextInt();
		  	       switch(c) {
		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		  		   break;
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2() {
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 7.85L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
		  	...
		  	// payment method for variant 4
		  		  	public void pay3() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 8.49L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 8.78L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
		  		...
		  		// payment method for variant 5  	
		  		  ...
		  		  public void pay4() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 6.99L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
		  		...
		  		// payment method for variant 6 	
		  		 public void pay5() {
	 		  		  ...
	 		  		  break;
	 		  		   case 2:System.out.println("your amount is 8.21L for payment press 1 |To exit press 2");
	 		  		   int c=sc.nextInt();
	 		  	       switch(c) {
	 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
	 		  		   break;
		  	...
		  	// payment method for variant 7	
		  		 public void pay6() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 9.09L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
	 		  		  ...
	 		  		  break;
	 		  		   case 2:System.out.println("your amount is 9.54L for payment press 1 |To exit press 2");
	 		  		   int c=sc.nextInt();
	 		  	       switch(c) {
	 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
	 		  		   break;
	...
	public void vari() {
		...
		System.out.println("1:PUNCH PURE|2:ADVANTURE|3:ACCOMPLISHED|4:ADVENTURE|5:ADVANTURE AMT|6:ACCOMPLISHED AMT|7:CREATIVE AMT");
		Punch s=new Punch("PURE","1199cc","Manual",5,18.67);
		Punch s1=new Punch("ADVANTURE","1199cc","Manual",5,18.67);
		Punch s2=new Punch("ACCOMPLISHED","1199cc","Automatic",5,18.67);
		Punch s3=new Punch("ADVANTURE ","1199cc","Manual",5,18.67);
		Punch s4=new Punch("ADVANTURE AMT","1199cc","Automatic",5,18.67);
		Punch s5=new Punch("ACCOMPLISHED AMT","1199cc","Automatic",5,18.67);
		Punch s6=new Punch("CREATIVE AMT","1199cc","Automatic",5,18.67);
		Scanner sc=new Scanner(System.in);
		int i=sc.nextInt();
		switch(i) {
		case 1:
