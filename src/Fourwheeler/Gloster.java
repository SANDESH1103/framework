...
public class Gloster extends Mg {
	String varient;
	String engine;
	String transmission;
	int capacity;
   ...
   Gloster(){
	...
	Gloster(String varient,String engine,String transmission,int capacity,double mileage){
		...
		public void payD() {
		   ...
		   int a=sc.nextInt();
		  		   switch(a)
		   {
		   case 1: System.out.println("your amount is 29.98L for payment press 1 |To exit press 2");
		        int b=sc.nextInt();
		  ...
		  break;
		   case 2:System.out.println("your amount is 30.95L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1D() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 36.18L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  		  ...
		  		  break;
		  		   case 2:System.out.println("your amount is 37.89L for payment press 1 |To exit press 2");
		  		   int c=sc.nextInt();
		  	       switch(c) {
		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		  		   break;
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2D() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 37.68L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 38.79L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
	...
	public void vari1() {
		...
		System.out.println("1:SMART|2:SHARP|3:SAVVY");
		Gloster s=new Gloster("SMART","1996cc","Automatic",5,12.40);
		Gloster s1=new Gloster("SHARP","1996cc","Automatic",5,12.40);
		Gloster s2=new Gloster("SAVVY","1996cc","Automatic",5,12.40);
