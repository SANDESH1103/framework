...
public class Harrier extends Tata {
   ...
   Harrier(){
	...
	Harrier(String varient,String engine,String transmission,int capacity,double mileage){
	...
	public void pay() {
		   ...
		   int a=sc.nextInt();
		  		   switch(a)
		   {
		   case 1: System.out.println("your amount is 14.39L for payment press 1 |To exit press 2");
		        int b=sc.nextInt();
		  ...
		  break;
		   case 2:System.out.println("your amount is 15.31L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 15.79L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  		  ...
		  		  break;
		  		   case 2:System.out.println("your amount is 16.32L for payment press 1 |To exit press 2");
		  		   int c=sc.nextInt();
		  	       switch(c) {
		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		  		   break;
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 17.04L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 17.56L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
		  	...
		  	// payment method for variant 4
		  		  	public void pay3() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 18.01L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		  		...
		  		// payment method for variant 5  	
		  		  ...
		  		  public void pay4() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 19.01L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
	 		  		  ...
	 		  		  break;
	 		  		   case 2:System.out.println("your amount is 19.96L for payment press 1 |To exit press 2");
	 		  		   int c=sc.nextInt();
	 		  	       switch(c) {
	 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
	 		  		   break;
		  		...
		  		// payment method for variant 6 	
		  		 public void pay5() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 20.01L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
	 		  		  ...
	 		  		  break;
	 		  		   case 2:System.out.println("your amount is 20.84L for payment press 1 |To exit press 2");
	 		  		   int c=sc.nextInt();
	 		  	       switch(c) {
	 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
	 		  		   break;
		  	...
		  	// payment method for variant 7	
		  		 public void pay6() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 21.04L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
		  		 ...
		  		 //this is entry method 
	
	public void vari1() {
		System.out.println("Please select one Varient");
		System.out.println("1:XE|2:XM|3:XT|4:XZ|5:XMA AMT|6:XT PLUS*|7:XZA PLUS");
		Harrier s=new Harrier("XE","1956cc","Manual",5,17);
		Harrier s1=new Harrier("XM","1956cc","Manual",5,17);
		Harrier s2=new Harrier("XT","1956cc","Automatic",5,17);
		Harrier s3=new Harrier("XZ","1956cc","Manual",5,17);
		Harrier s4=new Harrier("XMA AMT","1956cc","Automatic",5,17);
		Harrier s5=new Harrier("XT PLUS","1956cc","Manual",5,17);
		Harrier s6=new Harrier("XZA PLUS","1956cc","Automatic",5,17);
		Scanner sc=new Scanner(System.in);
		int i=sc.nextInt();
		switch(i) {
		case 1:
