...
public class Thar extends Mahindra{
	...
	Thar(String varient,String engine,String transmission,int capacity,double mileage){
	...
	public void pay() {
		   ...
		   int a=sc.nextInt();
		  		   switch(a)
		   {
		   case 1: System.out.println("your amount is 12.78L for payment press 1 |To exit press 2");
		        int b=sc.nextInt();
		  ...
		  break;
		   case 2:System.out.println("your amount is 13.06L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 13.38L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  		  ...
		  		  break;
		  		   case 2:System.out.println("your amount is 13.76L for payment press 1 |To exit press 2");
		  		   int c=sc.nextInt();
		  	       switch(c) {
		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		  		   break;
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 14.78L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		  	...
		  	// payment method for variant 4
		  		  	public void pay3() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 14.88L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
	...
	public void vari() {
		...
		System.out.println("1:AX,2:LX HARD TOP|3:LX CONVERT TOP AMT|4:LX HARD TOP AMT");
		Thar s=new Thar("AX","1997cc","Manual",4,15.20);
		Thar s1=new Thar("LX HARD TOP","1997cc","Manual",4,15.20);
		Thar s2=new Thar("LX CONVERT TOP AMT ","1997cc","Automatic",4,15.20);
		Thar s3=new Thar("LX HARD TOP AMT ","1197cc","Automatic",4,15.20);
	...
	public void payD() {
		  ...
		  break;
		   case 2:System.out.println("your amount is 13.65L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1D() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 13.68L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2D() {
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 15.89L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
		  	...
		  	// payment method for variant 4
		  		  	public void pay3D() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 15.08L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 15.96L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
	...
	public void vari1() {
		System.out.println("Please select one Varient");
		System.out.println("1:AX,2:LX HARD TOP|3:LX CONVERT TOP AMT|4:LX HARD TOP AMT");
		Thar s=new Thar("AX","2184cc","Manual",4,15.20);
		Thar s1=new Thar("LX HARD TOP","2184cc","Manual",4,15.20);
		Thar s2=new Thar("LX CONVERT TOP AMT ","2184cc","Automatic",4,15.20);
		Thar s3=new Thar("LX HARD TOP AMT ","2184cc","Automatic",4,15.20);
