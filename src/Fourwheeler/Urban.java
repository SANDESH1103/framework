...
public class Urban extends Toyota{
	String varient;
	String engine;
	String transmission;
	int capacity;
	...
	Urban(String varient,String engine,String transmission,int capacity,double mileage){
	...
	// payment method for variant 2
		  		 public void pay1() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 9.47L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  		  ...
		  		  break;
		  		   case 2:System.out.println("your amount is 1.01L for payment press 1 |To exit press 2");
		  		   int c=sc.nextInt();
		  	       switch(c) {
		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		  		   break;
		  	...
		  	// payment method for variant 4
		  		  	public void pay3() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 9.92L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		  		...
		  		// payment method for variant 5  	
		  		  ...
		  		  public void pay4() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 10.77L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
	 		  		  ...
	 		  		  break;
	 		  		   case 2:System.out.println("your amount is 11.32L for payment press 1 |To exit press 2");
	 		  		   int c=sc.nextInt();
	 		  	       switch(c) {
	 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
	 		  		   break;
		  		...
		  		// payment method for variant 6	
		  		  ...
		  		  public void pay5() {
	 		  		   ...
	 		  		   int a=sc.nextInt();
	 		  		  		   switch(a)
	 		  		   {
	 		  		   case 1: System.out.println("your amount is 11.40L for payment press 1 |To exit press 2");
	 		  		        int b=sc.nextInt();
	 		  		  ...
	 		  		  break;
	 		  		   case 2:System.out.println("your amount is 12.04L for payment press 1 |To exit press 2");
	 		  		   int c=sc.nextInt();
	 		  	       switch(c) {
	 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
	 		  		   break;
	...
	public void vari() {
		...
		System.out.println("1:MID|2:HIGH|3.PREMIUM|4:MID AMT|5:HIGH AMT|6.PREMIUM AMT");
		Urban s=new Urban("MID","1462cc","Manual",5,18.76);
		Urban s1=new Urban("HIGH","1462cc","Manual",5,18.76);
		Urban s2=new Urban("PREMIUM","1462cc","Manual",5,18.76);
		Urban s3=new Urban("MID AMT ","1462cc","Automatic",5,18.76);
		Urban s4=new Urban("HIGH AMT","1462cc","Automatic",5,18.76);
		Urban s5=new Urban("PREMIUM AMT","1462cc","Automatic",5,18.76);
		Scanner sc=new Scanner(System.in);
		int i=sc.nextInt();
		switch(i) {
		case 1:
