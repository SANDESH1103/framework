...
public class TataH extends Eightwheeler{
	String varient;
	String engine;
	String transmission;
	String capacity;
	...
	TataH(String varient,String engine,String transmission,String capacity,double mileage){
	...
	public void pay() {
		  ...
		  break;
		   case 2:System.out.println("your amount is 53.11L for payment press 1 |To exit press 2");
		   int c=sc.nextInt();
	       switch(c) {
	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		   break;
	...
	// payment method for variant 2
		  		 public void pay1() {
		  		   ...
		  		   int a=sc.nextInt();
		  		  		   switch(a)
		  		   {
		  		   case 1: System.out.println("your amount is 38.57L for payment press 1 |To exit press 2");
		  		        int b=sc.nextInt();
		  		  ...
		  		  break;
		  		   case 2:System.out.println("your amount is 44.03L for payment press 1 |To exit press 2");
		  		   int c=sc.nextInt();
		  	       switch(c) {
		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		  		   break;
		  	...
		  	// payment method for variant 3
		  		 ...
		  		 public void pay2() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 42.53L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 44.53L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
...
// payment method for variant 4
		  		 ...
		  		 public void pay3() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 35.26L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 38.82L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
...
// payment method for variant 5
		  		 ...
		  		 public void pay4() {
		 		  		   ...
		 		  		   int a=sc.nextInt();
		 		  		  		   switch(a)
		 		  		   {
		 		  		   case 1: System.out.println("your amount is 38.41L for payment press 1 |To exit press 2");
		 		  		        int b=sc.nextInt();
		 		  		  ...
		 		  		  break;
		 		  		   case 2:System.out.println("your amount is 43.60L for payment press 1 |To exit press 2");
		 		  		   int c=sc.nextInt();
		 		  	       switch(c) {
		 		  	       case 1: System.out.println("Thank you for your response we will contact you for more details");
		 		  		   break;
		  		...
		  		public void type() {
		  			...
		  			System.out.println("1:SIGNA 4825|2:LPT 4225|3:LPT 4825|4:3518 COWL|5:PRIMA FL 5530S");
		  			TataH s=new TataH("SIGNA 4825(16 tyres)","6700cc","Manual","25000kg",5.12);
		  			TataH s1=new TataH("LPT 4225(14 tyres)","6700cc","Manual","18000kg",4.05);
		  			TataH s2=new TataH("LPT 4825(16 tyres)","6700cc","Manual","25000kg",5.02);
		  			TataH s3=new TataH("3518 COWL (12 tyres)","5600cc","Manual","12000kg",4.15);
		  			TataH s4=new TataH("PRIMA FL 5530S(22 tyres)","6700cc","Manual","30000kg",2.56);
