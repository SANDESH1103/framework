...
public class PomEnterTimeTaskTimeLineComment {
	@FindBy(id = "username")
	...
	@FindBy (xpath = "(//img[@title='Click to edit comments'])[10]")
	private WebElement clickOneditToComment;
	@FindBy (xpath = "//textarea[@id='editDescriptionPopupText']")
	private WebElement writEditToComment;
	@FindBy(xpath = "//input[@id='scbutton']")
	WebElement clickSaveBtnElement;
	public PomEnterTimeTaskTimeLineComment(WebDriver driver) {
	...
	public void clickOneditToComment() {
		clickOneditToComment.click();
	}
	public void writEditToComment(String comment) {
		writEditToComment.sendKeys(comment);
	}
	public void clickSaveBtnElement() {
