...
public class ReportsProfitLoss {
	static {
	...
	@Test
	public void reportsProfitLoss() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@class='x-menu-item'])[9]")).click();
		Thread.sleep(2000);
