...
public class ReportTimeTrackDetails {
	static {
	...
	@Test
	public void reportTimeTrackDetails() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@placeholder='Enter Report Name'])[1]")).sendKeys("Time track details");
