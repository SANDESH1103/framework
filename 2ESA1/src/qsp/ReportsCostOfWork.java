...
public class ReportsCostOfWork {
	static {
	...
	@Test
	public void reportsCostOfWork() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@class='x-menu-item'])[8]")).click();
		Thread.sleep(2000);
