...
public class PomEnterTaskTrackHideRow {
	@FindBy(id = "username")
	...
	@FindBy(xpath = "(//a[@onclick='deleteTimeTrack(142); return false;'])[1]")
	private WebElement clickHideRow;
	@FindBy(xpath = "(//input[@value='Save Changes'])[1]")
	private WebElement clickSavechanges;
	
	public PomEnterTaskTrackHideRow(WebDriver driver) {
