...
public class TimeTrackReportedTimeAddManagerRemoveManager {
	static {

		System.setProperty("webdriver.chrome.driver", "D:\\Selinium\\2ESA1\\driver\\chromedriver.exe");
	}
	@Test
	public void timeTrackReportedTimeAddManagerRemoveManager() throws InterruptedException {
	...
	Thread.sleep(2000);
	driver.findElement(By.xpath("(//div[@class='deleteIcon'])[3]")).click();
	}
}
