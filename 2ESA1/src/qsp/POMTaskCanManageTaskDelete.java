...
public class POMTaskCanManageTaskDelete {
	@FindBy(id = "username")
	...
	/*
	 * @FindBy(xpath = "(//div[.='Enter hours'])[1]") private WebElement
	 * sendEstimate;
	 */
	@FindBy(xpath="//div[@class='delete button']")
	private WebElement clickDelete;
	@FindBy(xpath="(//span[@class='submitTitle buttonTitle'])[3]")
	private WebElement clickDel;
	

	 public POMTaskCanManageTaskDelete(WebDriver driver) {
	...
	public void clickDelete() {
		...
		clickDelete.click(); // utilization
	}
	public void clickDel() {

		clickDel.click(); // utilization
	}
}
