...
public class PomEnterTimeTrackTaskActionsMove {
	@FindBy(id = "username")
	...
	@FindBy(xpath = "(//div[contains(.,'Move to')])[9]")
	private WebElement clickOnMoveBtn;
	/*
	 * @FindBy (xpath = "(//div[@class='dropdownButton'])[2]") private WebElement
	 * clickOndropdown;
	 */
	 ...
	 * selectProject ;
	 * 
	 * @FindBy(xpath = "(//div[@class='ok button'])[1]") private WebElement
	 * clickOnMove;
	 */
	
	
	
	public PomEnterTimeTrackTaskActionsMove(WebDriver driver) {
	...
	public void clickOnMoveBtn() {
		clickOnMoveBtn.click();

	}

	/*
	 * public void clickOndropdown() { clickOndropdown.click();
	 * 
	 * }
	 */
	...
	/*
	 * public void clickOndropdown1() { clickOndropdown1.click();
	 * 
	 * } public void selectProject() { selectProject.click();
	 * 
	 * } public void clickOnMove() { clickOnMove.click();
	 * 
	 * }
	 */
}
