...
public class ReportInvoiceExport {
	...
	@Test
	public void reportInvoiceExport() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@class='x-menu-item'])[7]")).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath("//span[contains(.,'Create Invoice on Detailed Preview')]")).click();
		Thread.sleep(2000);
