...
public class ReportsEstimatedVsActualTime {
	static {
	...
	@Test
	public void reportsEstimatedVsActualTime() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@class='x-menu-item'])[5]")).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath("(//span[contains(.,'Generate HTML Report')])[3]")).click();
		Thread.sleep(2000);
		//driver.findElement(By.xpath("(//div[contains(.,'Add to Dashboard')])[5]")).click(); //element hidden click it manually
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//input[@placeholder='Enter Report Name'])[1]")).sendKeys("Estimated vs actual time");
