...
public class ReportTimeBalanceAndOvertime {
	static {
	...
	@Test
	public void reportTimeBalanceAndOvertime() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[@class='x-menu-item'])[2]")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//input[@placeholder='Enter Report Name'])[1]"))
				.sendKeys("TimeBalance and overtime");
